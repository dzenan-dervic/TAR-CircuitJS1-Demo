...
class EditInfo {
	...
	boolean positive;
	boolean nonNegative;
	/** 0 = unbegrenzt; sonst maxlength im Textfeld (EGT-Beschriftung). */
	int maxTextLen;
	...
	EditInfo setPositive() { positive = true; return this; }
	EditInfo setNonNegative() { nonNegative = true; return this; }
